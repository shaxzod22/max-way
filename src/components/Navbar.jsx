...
const Navbar = () => {
  ...
  return (
    ...
    <Link className={` flex w-full justify-between items-center px-4 xl:px-0 mb-[3px]`} to={'/'}>
    ...
    <Link className={` flex w-full justify-between items-center px-4 xl:px-0 mb-[3px]`} to={'/branches'}>
    ...
    <Link className={` flex w-full justify-between items-center px-4 xl:px-0 mb-[3px]`} to={'/about'}>
    ...
    <Link className={` flex w-full justify-between items-center px-4 xl:px-0 mb-[3px]`} to={'/contact'}>
